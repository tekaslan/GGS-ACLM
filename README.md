...
This repository provides a C/C++ implementation of a **Gradient-guided Search for Aircraft Path Planning** in dense and constrained airspace. The framework enables path planning with air traffic deconfliction and minimizes operational disruptions during emergency mitigation by combining spatial risk modeling and 4D trajectory search considering degraded fixed-wing aircraft performance.
...
@misc{ggs_aclm,
      ...
      archivePrefix={arXiv},
      primaryClass={cs.RO},
      url={https://arxiv.org/abs/2602.07074}, 
}
```
